...
from torchao.float8.hifloat8_utils import is_hifloat8_tensor
...
class Float8AQTTensorImpl(AQTTensorImpl):
    ...
    def from_plain(
        ...
        is_meta_hif8 = data.device.type == "meta" and data.dtype in (
            torch.uint8,
            torch.int8,
        )
        assert _is_float8_type(data.dtype) or is_hifloat8_tensor(data) or is_meta_hif8, (
    ...
    def check_aqt(aqt: Union[torch.Tensor, AffineQuantizedTensor]) -> bool:
        return (
            ...
            and (
                ...
                or is_hifloat8_tensor(aqt.tensor_impl.float8_data)
            )
...
def _linear_fp_act_fp8_weight_check(
    ...
    return (
        ...
        and (
            ...
            or is_hifloat8_tensor(weight_tensor.tensor_impl.float8_data)
        )
        and (
